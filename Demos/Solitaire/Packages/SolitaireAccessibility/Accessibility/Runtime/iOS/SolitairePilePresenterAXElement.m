...
@interface SolitairePilePresenterAXElement : UnityAccessibilityNode
@end
...
- (CGRect)unitySpaceAccessibilityFrame
{
    if ( self.solitairePresenterType == SolitairePresenterTypeTableau )
    {
        ...
        NSArray *rectArray = [cards ucMapedObjectsWithBlock:^id _Nonnull(UCComponent * _Nonnull obj) {
            UCSpriteRenderer *sprite = SAFE_CAST_CLASS(UCSpriteRenderer, [obj getComponentInChildren:@"UnityEngine.SpriteRenderer"]);
            return [NSValue ucValueWithCGRect:[sprite unityAXFrameInScreenSpace]];
        }];
    ...
    else if ( self.solitairePresenterType == SolitairePresenterTypeWaste )
    {
        ...
        NSArray *rectArray = [cards ucMapedObjectsWithBlock:^id _Nonnull(UCComponent * _Nonnull obj) {
            return [NSValue ucValueWithCGRect:[SAFE_CAST_CLASS(UCSpriteRenderer, [obj getComponentInChildren:@"UnityEngine.SpriteRenderer"]) unityAXFrameInScreenSpace]];
        }];
        return UCRectForRects([SAFE_CAST_CLASS(UCSpriteRenderer, [self.transform getComponentInChildren:@"UnityEngine.SpriteRenderer"]) unityAXFrameInScreenSpace], UCUnionRects(rectArray));
    }
    else
    {
        return [SAFE_CAST_CLASS(UCSpriteRenderer, [self.transform getComponentInChildren:@"UnityEngine.SpriteRenderer"]) unityAXFrameInScreenSpace];
    }
}
