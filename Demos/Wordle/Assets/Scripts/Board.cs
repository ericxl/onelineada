...
public class Board : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Backspace) || iOSInput.GetKeyDown(KeyCode.Backspace))
        {
            columnIndex = Mathf.Min(Mathf.Max(columnIndex - 1, 0), 4) ;

            if (currentRow.tiles.Length > 0)
            {
        ...
        {
            if (Input.GetKeyDown(KeyCode.Return) || iOSInput.GetKeyDown(KeyCode.Return)) {
        ...
        else
        {
            ...
            {
                if (Input.GetKeyDown(SUPPORTED_KEYS[i]) || iOSInput.GetKeyDown(SUPPORTED_KEYS[i]))
                {
